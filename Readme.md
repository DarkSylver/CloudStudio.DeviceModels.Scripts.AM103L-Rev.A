...
# Parsing + Configuration Script – AM103L - Rev. A

This **Parsing + Configuration** script is designed for the **AM103L** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AM103L Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AM103L** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
